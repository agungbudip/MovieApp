...
public class MoviePopularRepository {
    private static MoviePopularRepository instances;

    private MutableLiveData<List<Movie>> items;

    public static MoviePopularRepository getInstances() {
        if (instances == null) {
            instances = new MoviePopularRepository();
    ...
    public void loadData(final int page) {
        ...
        client.getPopularMovies(page, "c6a8ab2a50d10a5c5a194ecd0f637f8b").enqueue(new Callback<MovieGetResponse>() {
            @Override
