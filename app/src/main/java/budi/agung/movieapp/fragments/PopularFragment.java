...
public class PopularFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parent = inflater.inflate(R.layout.fragment_popular, container, false);
        initVariable();
        initComponent();
        if (visible) {
            initData();
    ...
    private void initVariable() {
        ...
        adapter = new MovieAdapter(context, items, new MovieAdapter.EventListener() {
            ...
            public void onReachBottom(int position) {
                ...
                nextPage = page + 1;
                movieViewModel.loadData(page, MovieModel.CATEGORY_POPULAR);
            }
        });

        movieViewModel = ViewModelProviders.of(this).get(MovieViewModel.class);
        movieViewModel.getItems(MovieModel.CATEGORY_POPULAR).observe(this, new Observer<List<Movie>>() {
            @Override
